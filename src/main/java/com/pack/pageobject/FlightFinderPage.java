...
public class FlightFinderPage {
	...
	/*
	 * public void clickContinue(){ WebElement element =
	 * driver.findElement(continueBtn); if
	 * (element.isDisplayed()||element.isEnabled()) element.click(); else
